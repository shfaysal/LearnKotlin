package com.example.learnkotlin.UIPractice.shimmeringEffect
    ...
    if (isLoadingCompleted){
        ...
        return composed {
            ...
            val translateAnimation = transition.animateFloat(
                initialValue = 0f,
                targetValue = (durationMils + widthOfShadowBrush).toFloat(),
                animationSpec = infiniteRepeatable(
                    animation = tween (
                        durationMillis = durationMils,
                        easing = LinearEasing
                    ),
